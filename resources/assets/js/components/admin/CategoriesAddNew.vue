<template>
    ...
    <div>
        <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#addNewModal"><i class="fa fa-plus"></i>
            Add new category</a>
        <!-- Modal -->
        <div class="modal fade settings-modal" id="addNewModal" tabindex="-1" role="dialog"
