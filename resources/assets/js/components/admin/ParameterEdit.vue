    ...
    <div class="part full-part">
        <div class="row">
            ...
            <div class="col-md-2 form-group">
                <hr>
                <label>
                    <input class="checkbox" type="checkbox" name="multilingual" v-model="multilingualTitle"
                           @change="setMultilingualTitle">
...
<!--                <hr>-->
<!--                <label>-->
<!--                    <input class="checkbox" type="checkbox" name="multilingual" v-model="multilingualUnit"-->
<!--                           @change="setMultilingualUnit">-->
...
<!--            </div>-->
            <div class="col-md-2 form-group">
                <hr>
                <label>
                    <input class="checkbox" type="checkbox" name="multilingual" v-model="multilingual"
                           @change="setMultilingual">
        ...
        <div class="categories-area" v-if="showCategories">
            ...
            <ul class="cats-tree">
                ...
                <li v-for="category in categories">
                    <label>
                        <input type="checkbox" v-model="checkedCategories[category.id]" class="checkbox"
                    ...
                    <ul>
                        <li v-for="children in category.children" v-if="category.children.length !== 0">
                            <label>
                                <input type="checkbox" v-model="checkedCategories[children.id]" class="checkbox"
                                       @change="checkCategory(children.id)">
                                <span>{{ children.translation.name }}</span>
                            </label>
                            <ul>
                                <li v-for="children2 in children.children" v-if="children.children.length !== 0">
                                    <label>
                                        <input type="checkbox" v-model="checkedCategories[children2.id]"
                                               class="checkbox" @change="checkCategory(children2.id)">
                                        <span>{{ children2.translation.name }}</span>
                                    </label>
                                    <ul>
                                        <li v-for="children3 in children2.children"
                                            v-if="children2.children.length !== 0">
                                            <label>
                                                <input type="checkbox" v-model="checkedCategories[children3.id]"
                                                       class="checkbox" @change="checkCategory(children.id)">
