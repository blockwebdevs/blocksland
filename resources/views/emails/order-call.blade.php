                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table bgcolor="#ffffff" class="es-header-body" align="center" cellpadding="0"
                                ...
                                <tr>
                                    <td align="left" bgcolor="#2B1D1A"
                                        style="Margin:0;padding-top:10px;padding-bottom:10px;padding-left:20px;padding-right:20px;background-color:#2b1d1a">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <img
                                                                    src="https://klavwb.stripocdn.email/content/guids/CABINET_789eca2e6cf605bec7d0c33d96afd441/images/image.jpeg"
                                                                    alt="Logo"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-m-p0r es-m-p0l"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    Detaliile utilizatorului sunt afișate mai jos.</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td style="padding:0;Margin:0">
                                                                <table class="table-costum" role="presentation"
                                                                       style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:100%;border:none">
                                                                    <tr>
                                                                        <td style="width:35%!important;padding:10px;Margin:0;width:40%;border-bottom:1px solid #EEEEEE;text-align:right;font-size:12px">
                                                                            Nume:
                                                                        </td>
                                                                        <td style="width:65%!important;padding:10px;Margin:0;width:40%;border-bottom:1px solid #EEEEEE;text-align:right;font-size:12px">
                                                                            <b style="text-align:left;display:block;padding-left:20px;font-size:14px">{{ $first_name ?? '---'}}</b>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:35%!important;padding:10px;Margin:0;width:40%;border-bottom:1px solid #EEEEEE;text-align:right;font-size:12px">
                                                                        ...
                                                                        <td style="width:65%!important;padding:10px;Margin:0;width:40%;border-bottom:1px solid #EEEEEE;text-align:right;font-size:12px">
                                                                            <b style="text-align:left;display:block;padding-left:20px;font-size:14px">{{ $email ?? '---'}}</b>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:35%!important;padding:10px;Margin:0;width:40%;border-bottom:1px solid #EEEEEE;text-align:right;font-size:12px">
                                                                        ...
                                                                        <td style="width:65%!important;padding:10px;Margin:0;width:40%;border-bottom:1px solid #EEEEEE;text-align:right;font-size:12px">
                                                                            <b style="text-align:left;display:block;padding-left:20px;font-size:14px">{{ $phone ?? '---' }}</b>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:35%!important;padding:10px;Margin:0;width:40%;border-bottom:1px solid #EEEEEE;text-align:right;font-size:12px">
                                                                        ...
                                                                        <td style="width:65%!important;padding:10px;Margin:0;width:40%;border-bottom:1px solid #EEEEEE;text-align:right;font-size:12px">
                                                                            <b style="text-align:left;display:block;padding-left:20px;font-size:14px">{{ $additional_3 ?? '---'}}</b>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:35%!important;padding:10px;Margin:0;width:40%;border-bottom:1px solid #EEEEEE;text-align:right;font-size:12px">
                                                                        ...
                                                                        <td style="width:65%!important;padding:10px;Margin:0;width:40%;border-bottom:1px solid #EEEEEE;text-align:right;font-size:12px">
                                                                            <b style="text-align:left;display:block;padding-left:20px;font-size:14px">{{ $additional_1 ?? '---' }}</b>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:35%!important;padding:10px;Margin:0;width:40%;border-bottom:1px solid #EEEEEE;text-align:right;font-size:12px">
                                                                        ...
                                                                        <td style="width:65%!important;padding:10px;Margin:0;width:40%;border-bottom:1px solid #EEEEEE;text-align:right;font-size:12px">
                                                                            <b style="text-align:left;display:block;padding-left:20px;font-size:14px">{{ date('h:i d-m-Y') }}</b>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0"><p
                                                                    ...
                                                                    Manole Estate © {{ date('Y') }}&nbsp; All Rights
                                                                    Reserved.</p>
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;color:#333333;font-size:12px">
                                                                    Moldova, Chisinau, str.Columna 90, tel +(373) 79 995
                                                                    455</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-infoblock"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:14px;color:#CCCCCC;font-size:12px">
                                                                    În cazul în care acest mail nu se referă la Dvs, Vă
                                                                    rugăm să ignorați acest mesaj.</p>
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:14px;color:#CCCCCC;font-size:12px">
