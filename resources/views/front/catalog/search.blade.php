...
@section('content')
    ...
    <div class="container content">
        <div class="breadcrumbs">
            ...
            <a href="#">{{ trans('vars.general.search') }}</a>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="heading-h1">
                    <h1>{{ trans('vars.general.search') }} - "{{ Request::get('search') }}"</h1>
                </div>
                ...
                <div class="row products">
                            ...
                            <div class="item-inside">
                                ...
                                <a href="{{ url('/'. $lang->lang .'/catalog/'.$product->category->translation->slug. '/'. $product->translation->slug) }}">
                                    @if($product->mainImage)
                                        <img src="{{ asset('/images/products/sm/' . $product->mainImage->src)  }}" alt="">
                                    @else
                                        <img src="{{ asset('/images/stub.png')  }}" alt="">
                                    @endif
                                </a>
                    ...
                    @else
                        <div class="col-md-12">
                            {{ trans('vars.notifications.nothingFound') }}
                        </div>
                    @endif
                </div>
