                            ...
                            @foreach($languages as $key => $language)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                            <form action="{{ route('languages.default', $language->id) }}"
                                                  method="post">
...
{{--                                                    data-target="#actions{{ $language->id }}">--}}
...
{{--                                        @endif--}}
                                            ---
                                        <div class="modal fade" id="actions{{ $language->id }}" tabindex="-1"
                                             role="dialog" aria-labelledby="actions{{ $language->id }}"
                                             aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{ route('languages.active', $language->id) }}"
                                                              method="post">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
                                                            @if ($language->active )
...
{{--                        <h5>Create new</h5>--}}
{{--                        <hr>--}}
{{--                        <form class="form-reg" role="form" method="POST" action="{{ route('languages.store') }}"--}}
{{--                              id="add-form">--}}
{{--                            {{ csrf_field() }}--}}
...
{{--                                <input type="text" name="description" id="description" placeholder="English"--}}
