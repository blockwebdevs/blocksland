...
@section('content')
    ...
    <div class="title-block">
        <h3 class="title">Create New Testimonial</h3>
    ...
    <div class="list-content">
        <form class="form-reg" method="POST" action="{{ route('testimonials.store') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card">
                            ...
                            <div class="tab-content active-content"
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <textarea name="body" id="" cols="30" rows="10" class="name" required></textarea>
                                    </li>
                                    <li>
                                        <label>Author</label>
                                        <input type="text" name="author" class="name" required>
                                    </li>
                                </ul>
                            </div>
                        </div>
